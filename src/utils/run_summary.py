...
- logs/runs/{run_id}/summary.json        (final roll-up)
- logs/runs/{run_id}/summary.ndjson      (append-only events stream)
- logs/runs/{run_id}/contacts/{id}.json  (per-contact results)
"""
