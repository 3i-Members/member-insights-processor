...
from utils.claims import create_local_claimer
from concurrent.futures import ThreadPoolExecutor, as_completed
from uuid import uuid4
from utils.run_summary import RunSummaryWriter
import threading
                        ...
                        records_to_mark = [
                            {
                                ...
                                'metadata': {
                                    'batch_id': group_eni_id,
                                    'processor_system_prompt_key': system_prompt_key,
                                    'processor_generator': 'structured_insight',
                                }
                            }
    ...
    def process_multiple_contacts(
        ...
        try:
            ...
            if enable_parallel and max_workers > 1:
                rsw = RunSummaryWriter(run_id=run_id, base_dir='logs/runs')
