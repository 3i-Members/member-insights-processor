...
def test_environment_variables():
    ...
    has_credentials = found_vars['GOOGLE_CREDENTIALS_PATH'] or found_vars['GOOGLE_APPLICATION_CREDENTIALS']
            ...
            try:
                ...
                if not eni_types_df.empty:
                    ...
                    for _, row in eni_types_df.head(5).iterrows():
                        print(f"      - {row['eni_source_type']}/{row['eni_source_subtype']}: {row['count']} records")
