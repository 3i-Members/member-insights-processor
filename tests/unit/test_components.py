...
from member_insights_processor.io.readers.markdown import MarkdownReader
from member_insights_processor.io.log_manager import ProcessingLogManager
from member_insights_processor.io.writers.markdown import MarkdownWriter
...
def test_log_manager():
    ...
    print(
        f"   ✅ Processing stats: {stats['total_contacts']} contacts, {stats['total_processed_eni_ids']} ENI IDs"
    )
...
"""
    ...
    file_path = writer.write_summary(
        ...
        additional_metadata={"test_run": True, "system_version": "1.0.0"},
    )
