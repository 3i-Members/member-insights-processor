...
class TestSchemaValidation:
    ...
    def test_insight_metadata_creation(self):
        ...
        metadata = InsightMetadata(
            contact_id="CNT-c9M007641", eni_id="ENI-123456789", member_name="Test Member"
        )
    ...
    def test_structured_insight_creation(self):
        ...
        metadata = InsightMetadata(contact_id="CNT-c9M007641", eni_id="ENI-123456789")

        content = StructuredInsightContent(
            personal="Test personal info", business="Test business info"
        )
    ...
    def test_legacy_data_conversion(self):
        ...
        legacy_data = {
            ...
            "insights": {"personal": "Test personal", "business": "Test business"},
        }
    ...
    def test_json_validation(self):
        ...
        # Valid new format
        valid_new_data = {
            "metadata": {"contact_id": "CNT-c9M007641", "eni_id": "ENI-123456789"},
            "insights": {"personal": "Test personal"},
        }
        ...
        def validate_structured_insight_json(data):
            if (
                "metadata" in data
                and "contact_id" in data["metadata"]
                and "eni_id" in data["metadata"]
            ):
                return True, []
        ...
        # Invalid data
        invalid_data = {"metadata": {"contact_id": "INVALID-ID"}, "insights": {}}  # Invalid format
...
class TestSupabaseInsightsProcessor:
    ...
    def test_processor_initialization(self, mock_supabase_client):
        ...
        processor = SupabaseInsightsProcessor(supabase_client=mock_supabase_client, batch_size=5)
    ...
    def test_process_single_insight(self, mock_supabase_client):
        ...
        result_insight, was_created = processor.process_insight(
            contact_id="CNT-test123", eni_id="ENI-456", insight_content=content, metadata=metadata
        )
    ...
    def test_batch_processing(self, mock_supabase_client):
        ...
        processor = SupabaseInsightsProcessor(mock_supabase_client, batch_size=2)

        insights_data = [
            {
                "contact_id": "CNT-123",
                "eni_id": "ENI-456",
                "insights": {"personal": "Test personal 1"},
                "member_name": "Member 1",
            },
            {
                "contact_id": "CNT-789",
                "eni_id": "ENI-012",
                "insights": {"personal": "Test personal 2"},
...
class TestIntegrationWithRealData:
    ...
    def test_real_json_sample_parsing(self):
        ...
        sample_data = {
            ...
            "insights": {"raw_content": "Sample content with JSON structure..."},
        }
...
def sample_processing_data():
    ...
    return [
        ...
        },
        {
            ...
            "insights": {"investing": "* Sample investing info\n  * [2024-01-02,ENI-987654321]"},
...
class TestEndToEndProcessing:
    ...
    def test_complete_processing_workflow(self, mock_supabase_client, sample_processing_data):
        ...
        processor = SupabaseInsightsProcessor(mock_supabase_client, batch_size=1)
