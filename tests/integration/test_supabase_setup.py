...
class TestTableOperations:
    ...
    def test_insight_creation_flow(self, mock_create):
        ...
        # Create test insight
        metadata = InsightMetadata(contact_id="CNT-test123", eni_id="ENI-test456")
...
class TestSchemaCompatibility:
    ...
    def test_legacy_json_compatibility(self):
        ...
        legacy_data = {
            ...
            "insights": {"raw_content": "Test content"},
        }
    ...
    def test_new_format_compatibility(self):
        ...
        new_data = {
            "metadata": {"contact_id": "CNT-new123", "eni_id": "ENI-new456"},
            "insights": {"personal": "New personal info", "business": "New business info"},
        }
