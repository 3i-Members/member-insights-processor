...
class TestJSONWriter(unittest.TestCase):
    ...
    def test_read_structured_insight(self):
        ...
        # Create test file
        test_data = {
            "metadata": {"contact_id": "CNT-TEST002", "member_name": "Test Member 2"},
            "insights": {"personal": "Test personal info", "business": "Test business info"},
        }
    ...
    def test_airtable_data_extraction(self):
        ...
        sample_insight = {"personal": "* Test personal", "business": "* Test business"}
